...
- [ ] viewfinfoにダウンロード登録ボタンを追加する
- [ ] viewfinfoにコメントon/offボタンを追加する
- [x] 削除されている動画はviewfinfoで削除されていることを表示する
- [ ] 各ラベルを日本語表示にする
- [ ] bookmark機能（再生地点も記録）
- [x] 再生履歴
- [ ] 再生履歴で終了時の再生時間を記録
...
- [x] typo修正(ipc-load-nylist -> ipc-load-mylist)
