...
test("getObj json_data empty", t => {
    ...
    const json_data = {};
    t.is(config.getObj("test", json_data), undefined);
...
test("getObj json_data has obj", t => {
    ...
    t.deepEqual(config.getObj("test", json_data), {value1:10, value2:"val2", value3:{}});
    t.is(config.getObj("test.value1", json_data), 10);
    t.is(config.getObj("test.value2", json_data), "val2");
    t.deepEqual(config.getObj("test.value3", json_data), {});
    t.is(config.getObj("test.value4", json_data), undefined);
    t.is(config.getObj("test.value1.value1", json_data), undefined);
...
test("setObj add", t => {
    ...
    config.setObj("test", 1, json_data);
    t.deepEqual(json_data, {test:1});

    config.setObj("test", 2, json_data);
    t.deepEqual(json_data, {test:2});

    config.setObj("test.value1", 3, json_data);
    t.deepEqual(json_data, {test:{value1:3}});

    config.setObj("test.value1", 4, json_data);
    t.deepEqual(json_data, {test:{value1:4}});

    config.setObj("test.value2", 5, json_data);
    t.deepEqual(json_data, {test:{value1:4, value2:5}});

    config.setObj("test.value2", 6, json_data);
    t.deepEqual(json_data, {test:{value1:4, value2:6}});
    
    config.setObj("test", {value3:7}, json_data);
...
test("setObj replace obj", t => {
    ...
    config.setObj("test", {value:1}, json_data);
    t.deepEqual(json_data, {test:{value:1}});

    config.setObj("test", {value:2}, json_data);
    t.deepEqual(json_data, {test:{value:2}});

    config.setObj("test.value1", {value:3}, json_data);
    t.deepEqual(json_data, {test:{value:2, value1:{value:3}}});

    config.setObj("test.value1", {value:4}, json_data);
    t.deepEqual(json_data, {test:{value:2, value1:{value:4}}});

    config.setObj("test.value2", {value:5}, json_data);
    t.deepEqual(json_data, {test:{value:2, value1:{value:4}, value2:{value:5}}});

    config.setObj("test.value2", {value:6}, json_data);
