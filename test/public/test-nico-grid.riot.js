...
const { tagsFormatter } = require("../../src/renderer/common/nico-grid-formatter");
const { mountNicoGrid } = require("../../src/renderer/common/nico-grid-mount");
const myapi = require("../../src/lib/my-api");
const fs = require("fs");
const path = require("path");

const nico_grid_name = "test-nico-grid";
...
module.exports = {
    ...
    async onMounted() {  
        ...
        mountNicoGrid(`#${nico_grid_name}`, state, this.obs, columns, options);
