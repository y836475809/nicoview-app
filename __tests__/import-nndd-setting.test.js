...
const { ImportNNDDSetting } = require("../src/lib/import-nndd-setting");
...
test("parse nndd history", t => {
    ...
    t.deepEqual(data, [
        { thumb_img:thumbUrl1, video_id:"sm1", title:videoName1, time:0, play_date:1, url:url1 },
        { thumb_img:thumbUrl2, video_id:"sm2", title:videoName2, time:0, play_date:2, url:url2 },
    ]);
});
